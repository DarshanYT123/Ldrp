...
"
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex gap-x-44 px-10 flex-row  items-center py-4">
            ...
            <MotherDragDrop />
            {/* <div>
    <div className="border border-[color:var(--Desable-Grey,#BDBDBD)] border-dashed w-40 h-40"><h2 className="flex justify-center items-center text-center py-14 text-[color:var(--Desable-Grey,#BDBDBD)] text-[16px] font-inter  not-italic font-semibold leading-[normal] tracking-[0.32px] capitalize">Drag & Drop Or Open File</h2></div>
    <h2 className="py-2 text-[color:var(--black,#101010)] text-[16px] font-Poppins not-italic font-semibold leading-[normal] tracking-[0.32px] capitalize">Student Photo</h2>
        <button className="text-[color:var(--03,#FFF)] text-[16px] font-inter not-italic font-bold leading-[normal] tracking-[0.32px] capitalize px-10 shadow-[0px_4px_8px_0px_rgba(184,182,182,0.25)] rounded-[5px] py-2 bg-[#159BD6]">Upload</button>
    </div>
    <div>
    <div className="border border-[color:var(--Desable-Grey,#BDBDBD)] border-dashed w-40 h-40"><h2 className="flex justify-center items-center text-center py-14 text-[color:var(--Desable-Grey,#BDBDBD)] text-[16px] font-inter  not-italic font-semibold leading-[normal] tracking-[0.32px] capitalize">Drag & Drop Or Open File</h2></div>
          ...
          <div className="flex flex-row gap-x-20 py-4 ">
            <div className="">
              <table className="  ">
                ...
                <tr>
                  <td className=" p-3 table-auto1 border-[1px] border-[#47A5E4] w-40 text-[color:var(--black,#101010)] text-[16px] font-Poppins not-italic font-semibold leading-[normal] tracking-[0.32px] capitalize">
                    4th
                  </td>
                  <input
                    type="text"
